...
const translations = {
    ...
    // Hero
    "hero.title": "TOUKOLAN TERAPIA",
    "hero.subtitle": "Tukea ja apua **ilman lähetteitä** tai **diagnooseja**",
    "hero.cta": "Varaa aika",
  ...
  en: {
    ...
    // Hero
    "hero.title": "TOUKOLA THERAPY",
    "hero.subtitle": "Support and help **without referrals** or **diagnoses**",
    ...
    "about.more":
      "Our therapists **listen**, **encourage**, **observe** and **co-operate** according to our customers wishes and personal needs. In our work we make use of our **educational background**, **knowledge** and **skills** in the healthcare industry but aim to act as **fellow human beings** and **peers** rather than health care authorities. Depending on your needs, you can book a **short therapy visit** for example with a **nurse** or a **midwife**.",
    "about.experience":
    ...
    "happens.content1":
      "The content of brief therapy sessions varies depending on the therapists' **working methods** and the Your **individual needs**. **Initial sessions** often focus on **getting to know each other**, as well as defining **challenges** and **goals**. You may be asked, for example, about **background information** and the **reason for seeking therapy**.",
    "happens.content2":
